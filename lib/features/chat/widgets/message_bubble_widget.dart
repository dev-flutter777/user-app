      ...
      builder: (context, chatProvider, child) {
        ...
        return Column(
          ...
          children: [
            ...
            if (images.isNotEmpty) MediaGridWidget(images: images, isMe: isMe),
...
class MediaGridWidget extends StatefulWidget {
  ...
  const MediaGridWidget({super.key, required this.images, required this.isMe});
...
class _MediaGridWidgetState extends State<MediaGridWidget> {
  ...
  @override
  void didUpdateWidget(covariant MediaGridWidget oldWidget) {
