      ...
      internalWidget = InkWell(
        ...
        child: Padding(
          ...
          child: Flex(
            ...
            children: <Widget>[
              SizedBox(width: 25, child: Image.asset(widget.fromCountryList? Images.country : Images.callIcon, color: widget.isCallPrimary ? Theme.of(context).primaryColor : Theme.of(context).primaryColor.withValues(alpha:.4),)),
