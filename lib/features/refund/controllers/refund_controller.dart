...
class RefundController with ChangeNotifier {
  ...
  bool isRefundRequestedFor(int orderDetailsId) {
    if (_refundInfoModel == null) return false;
    if (_selectedOrderDetailsId == orderDetailsId) {
      return _refundInfoModel?.alreadyRequested ?? false;
    }
    return false;
  }
